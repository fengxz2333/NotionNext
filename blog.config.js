...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一名数字艺术创作者, 曾以Previs Artist身份参与过《流浪地球2》《独行月球》《宇宙探索编辑部》等电影作品',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FENX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '数字艺术创作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '微信：fxz757012716', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人作品集网站', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '757012716@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/322438863', // B站主页
  ...
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_THEME || null, // 点击宠物挂件切换博客主题
  ...
  ANALYTICS_BUSUANZI_ENABLE: process.env.NEXT_PUBLIC_ANALYTICS_BUSUANZI_ENABLE || '', // 展示网站阅读量、访问数 see http://busuanzi.ibruce.info/
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '个人作品集网站', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
